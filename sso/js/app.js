    ...
    async function _performFetchWithErrorHandling(auth, customErrorMap, fetchFn) {
        ...
        try {
            ...
            if (response.ok && !("errorMessage" in json)) return json; else {
                ...
                if ("FEDERATED_USER_ID_ALREADY_LINKED" === serverErrorCode) throw _makeTaggedError(auth, "credential-already-in-use", json); else if ("EMAIL_EXISTS" === serverErrorCode) throw _makeTaggedError(auth, "email-already-in-use", json);
 ...
 */
    async function _reauthenticate(user, credential, bypassAuthState = false) {
        ...
        try {
            ...
            if ((null === e || void 0 === e ? void 0 : e.code) === `auth/${"user-not-found"}`) _fail(auth, "user-mismatch");
            throw e;
        }
    }
    /**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */    const index_3b632d0b_DB_NAME = "firebaseLocalStorageDb";
    const index_3b632d0b_DB_VERSION = 1;
    ...
    function _deleteDatabase() {
        const request = indexedDB.deleteDatabase(index_3b632d0b_DB_NAME);
        return new DBPromise(request).toPromise();
    }
    function _openDatabase() {
        const request = indexedDB.open(index_3b632d0b_DB_NAME, index_3b632d0b_DB_VERSION);
        return new Promise(((resolve, reject) => {
 ...
 */    const WEB_STORAGE_SUPPORT_KEY = "webStorageSupport";
    ...
    var index_3b632d0b_name = "@firebase/auth";
    var index_3b632d0b_version = "0.20.1";
    /**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 */    function getVersionForPlatform(clientPlatform) {
    ...
    function registerAuth(clientPlatform) {
        ...
        registerVersion(index_3b632d0b_name, index_3b632d0b_version, getVersionForPlatform(clientPlatform));
        registerVersion(index_3b632d0b_name, index_3b632d0b_version, "esm2017");
    }
    /**
 * @license
 * Copyright 2021 Google LLC
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */    const index_esm2017_logClient = new Logger("@firebase/database");
    ...
    const enableLogging$1 = function(logger_, persistent) {
        ...
        if (true === logger_) {
            index_esm2017_logClient.logLevel = LogLevel.VERBOSE;
            index_esm2017_logger = index_esm2017_logClient.log.bind(index_esm2017_logClient);
    ...
    const error = function(...varArgs) {
        ...
        index_esm2017_logClient.error(message);
    };
    ...
    const warn = function(...varArgs) {
        ...
        index_esm2017_logClient.warn(message);
    };
    ...
    class PersistentConnection extends ServerActions {
        ...
        get(query) {
            ...
            if (!this.connected_) setTimeout((() => {
                ...
                if (void 0 === get || outstandingGet !== get) return;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */    var index_esm2017_OperationType;
    (function(OperationType) {
        OperationType[OperationType["OVERWRITE"] = 0] = "OVERWRITE";
        OperationType[OperationType["MERGE"] = 1] = "MERGE";
        OperationType[OperationType["ACK_USER_WRITE"] = 2] = "ACK_USER_WRITE";
        OperationType[OperationType["LISTEN_COMPLETE"] = 3] = "LISTEN_COMPLETE";
    })(index_esm2017_OperationType || (index_esm2017_OperationType = {}));
 ...
 */    class AckUserWrite {
        constructor(path, affectedTree, revert) {
            ...
            this.revert = revert;
            this.type = index_esm2017_OperationType.ACK_USER_WRITE;
 ...
 */
    class Overwrite {
        constructor(source, path, snap) {
            ...
            this.path = path;
            this.snap = snap;
            this.type = index_esm2017_OperationType.OVERWRITE;
        }
        operationForChild(childName) {
 ...
 */    class Merge {
        constructor(source, path, children) {
            ...
            this.type = index_esm2017_OperationType.MERGE;
        }
        operationForChild(childName) {
            if (pathIsEmpty(this.path)) {
 ...
 */    function newViewProcessor(filter) {
    ...
    function viewProcessorApplyOperation(viewProcessor, oldViewCache, operation, writesCache, completeCache) {
        ...
        if (operation.type === index_esm2017_OperationType.OVERWRITE) {
        ...
        } else if (operation.type === index_esm2017_OperationType.MERGE) {
        ...
        } else if (operation.type === index_esm2017_OperationType.ACK_USER_WRITE) {
        ...
        } else if (operation.type === index_esm2017_OperationType.LISTEN_COMPLETE) newViewCache = viewProcessorListenComplete(viewProcessor, oldViewCache, operation.path, writesCache, accumulator); else throw assertionError("Unknown operation type: " + operation.type);
    ...
    function viewProcessorApplyServerMerge(viewProcessor, viewCache, path, changedChildren, writesCache, serverCache, filterServerNode, accumulator) {
        ...
        viewMergeTree.children.inorderTraversal(((childKey, childMergeTree) => {
            const isUnknownDeepMerge = !viewCache.serverCache.isCompleteForChild(childKey) && void 0 === childMergeTree.value;
 ...
 */    class View {
    ...
    function viewApplyOperation(view, operation, writesCache, completeServerCache) {
        if (operation.type === index_esm2017_OperationType.MERGE && null !== operation.source.queryId) {
 ...
 */    const INTERRUPT_REASON = "repo_interrupt";
    ...
    function repoGetValue(repo, query) {
        ...
        return repo.server_.get(query).then((payload => {
            ...
            repoLog(repo, "get for query " + index_esm2017_stringify(query) + " failed: " + err);
 ...
 */
    ...
    function get(query) {
        ...
        return repoGetValue(query._repo, query).then((node => new DataSnapshot(node, new ReferenceImpl(query._repo, query._path), query._queryParams.getIndex())));
    }
 ...
 */
    ...
    function getUsersDB(userId) {
        ...
        if (database) get(child(dbRef, `users`)).then((snapshot => {
            if (snapshot.exists()) {
    ...
    if (regForm) regForm.addEventListener("submit", (e => {
        ...
        e.preventDefault();
        showPreloader();
        if (regPass === regRepeatPass) createUser(regMail, regPass); else {
